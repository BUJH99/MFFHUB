...
export const xSwordOptionDefinitions: XSwordOptionDefinition[] = [
  { id: 'damageDealtToAliens', label: 'Increase Basic Damage Dealt to Aliens', category: 'typeDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageDealtToHumans', label: 'Increase Basic Damage Dealt to Humans', category: 'typeDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageDealtToMutants', label: 'Increase Basic Damage Dealt to Mutants', category: 'typeDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageDealtToPureEvil', label: 'Increase Basic Damage Dealt to Pure Evil', category: 'typeDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageReceivedFromAliens', label: 'Decrease Basic Damage Received from Aliens', category: 'typeDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageReceivedFromHumans', label: 'Decrease Basic Damage Received from Humans', category: 'typeDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageReceivedFromMutants', label: 'Decrease Basic Damage Received from Mutants', category: 'typeDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageReceivedFromPureEvil', label: 'Decrease Basic Damage Received from Pure Evil', category: 'typeDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageDealtToJusticeInstinct', label: 'Increase Basic Damage Dealt to Justice Instinct', category: 'instinctDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageDealtToCrueltyInstinct', label: 'Increase Basic Damage Dealt to Cruelty Instinct', category: 'instinctDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageDealtToOrderInstinct', label: 'Increase Basic Damage Dealt to Order Instinct', category: 'instinctDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageDealtToDestructionInstinct', label: 'Increase Basic Damage Dealt to Destruction Instinct', category: 'instinctDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageReceivedFromJusticeInstinct', label: 'Decrease Basic Damage Received from Justice Instinct', category: 'instinctDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageReceivedFromCrueltyInstinct', label: 'Decrease Basic Damage Received from Cruelty Instinct', category: 'instinctDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageReceivedFromOrderInstinct', label: 'Decrease Basic Damage Received from Order Instinct', category: 'instinctDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'damageReceivedFromDestructionInstinct', label: 'Decrease Basic Damage Received from Destruction Instinct', category: 'instinctDamage', defaultValue: 2.5, step: 0.5 },
  { id: 'flameDamage', label: 'Flame Damage', category: 'elemental', defaultValue: 5, step: 0.5, statKey: 'elementalDamage' },
  { id: 'coldDamage', label: 'Cold Damage', category: 'elemental', defaultValue: 5, step: 0.5, statKey: 'elementalDamage' },
  { id: 'lightningDamage', label: 'Lightning Damage', category: 'elemental', defaultValue: 5, step: 0.5, statKey: 'elementalDamage' },
  { id: 'mindDamage', label: 'Mind Damage', category: 'elemental', defaultValue: 5, step: 0.5, statKey: 'elementalDamage' },
  { id: 'flameResist', label: 'Flame Resist', category: 'elemental', defaultValue: 5, step: 0.5 },
  { id: 'coldResist', label: 'Cold Resist', category: 'elemental', defaultValue: 5, step: 0.5 },
  { id: 'lightningResist', label: 'Lightning Resist', category: 'elemental', defaultValue: 5, step: 0.5 },
  { id: 'mindResist', label: 'Mind Resist', category: 'elemental', defaultValue: 5, step: 0.5 },
  { id: 'cooldownDuration', label: 'Cooldown Duration', category: 'utility', defaultValue: 4, step: 0.5, statKey: 'cooldownDuration' },
  { id: 'movementSpeed', label: 'Movement Speed', category: 'utility', defaultValue: 4, step: 0.5 },
  { id: 'concentration', label: 'Concentration', category: 'utility', defaultValue: 4, step: 0.5 },
  { id: 'crowdControlTime', label: 'Crowd Control Time', category: 'utility', defaultValue: 4, step: 0.5 },
  { id: 'instinctAttack', label: 'Instinct Attack', category: 'utility', defaultValue: 600, step: 100, statKey: 'instinctAttack' },
];
